...
hook.Add("RoundWin","rwin",function()
	...
	hook.Add("HUDPaint","CHRoundWinNotif",function()
		if SysTime()-timeex > 5 then hook.Remove("HUDPaint","CHRoundWinNotif") end
...
hook.Add("RoundLoss","rloss",function()
	...
	hook.Add("HUDPaint","CHRoundLossNotif",function()
		if SysTime()-timeex > 5 then hook.Remove("HUDPaint","CHRoundLossNotif") end
...
hook.Add("RoundTie","rtie",function()
	...
	hook.Add("HUDPaint","CHRoundTieNotif",function()
		if SysTime()-timeex > 5 then hook.Remove("HUDPaint","CHRoundTieNotif") end
